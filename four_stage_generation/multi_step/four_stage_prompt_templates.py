...
- BALANCE CHECK (HARD CONSTRAINT): No step may span fewer than 3 frames. No step may span more than 40%% of the total frames ({int(num_frames * 0.40)} frames). If violated, adjust boundaries — merge tiny steps with neighbors, split oversized steps.
