...
def initialize_openai_client(endpoint_override: str = "") -> AzureOpenAI:

    ep = endpoint_override or os.environ.get("API_BASE_URL", "") or ENDPOINT
...
def create_api_client(api_base_url: str = "", api_key: str = "") -> AzureOpenAI:
    ...
    return initialize_openai_client(endpoint_override=api_base_url or "")
